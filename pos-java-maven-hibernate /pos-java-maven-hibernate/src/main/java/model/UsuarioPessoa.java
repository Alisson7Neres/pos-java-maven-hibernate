...
@NamedQueries({
	...
	@NamedQuery(name = "UsuarioPessoa.buscaPorNome", query = "select u from UsuarioPessoa u where" +
	 " u.nome = :nome")
})
public class UsuarioPessoa {
	...
	@OneToMany(mappedBy = "usuarioPessoa", fetch = FetchType.EAGER) // Relacionamento de um para muitos
